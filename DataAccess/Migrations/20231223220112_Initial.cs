    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Giyim", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(63), "Erkek - Kadın - Çocuk kıyafet.", false },
                    { 4, "Elektronik", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(65), "Teknolojik araçlar.", false },
                    { 5, "Spor & Outdoor", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(67), "Spor ve dış giyim malzemeleri.", false },
                    { 7, "Ayakkabı", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(69), "Erkek - Kadın - Çocuk ayakkabı.", false },
                    { 9, "Kozmetik", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(70), "Makyaj ve kişisel bakım malzemeleri.", false },
                    { 11, "Ev & Yaşam", new DateTime(2023, 12, 24, 1, 1, 12, 491, DateTimeKind.Local).AddTicks(72), "Ev ve yaşam için gerekli genel malzemeler.", false }
                });
